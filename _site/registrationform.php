...
<meta name="keywords" content="data visualization, analytics, data mining, scalability issues, apis, data curation, virality, memes, big data, small data, case studies, ethics, privacy, surveillance, security, mathematical models, algorithms, network science, social analysis, media analysis, communications, economy, business models, applied sociology, psychology, anthropology, linguistics, crowdsourcing">
...
<br><p class="body" style="text-align:center!important; color: #FFF!important;">SNSM'17 is part of the <b>3<sup>rd</sup> World Congress on Electrical Engineering and Computer Systems and Science (EECSS'17)</b>.<br>For more information about the congress, please visit the website here: <a href="http://2017.eecss.org/" class="body-link">www.2017.eecss.org</a>.</p>
        </div>
        </div> 
      </div>
    </div>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">SNSM 2016 will  be held in Rome, Italy on June 4 - 6, 2017.</p>
